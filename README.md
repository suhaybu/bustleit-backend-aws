...
├── events/
│   └── test-events/
│       ├── recommend.json          # Test events for recommendation endpoints
│       ├── ai_userdata.json        # Test events for AI userdata endpoints
│       └── auth.json               # Test events for authentication
├── rust_app/
│   ├── src/
│   │   ├── handlers/             # Lambda function handlers
│   │   │   ├── mod.rs
│   │   │   ├── auth.rs             # Handles /auth/login endpoint
│   │   │   ├── ai.rs               # Handles /ai/* endpoints
│   │   │   ├── recommend.rs        # Handles /recommend endpoint
│   │   │   └── health.rs           # Handles health check endpoint
│   │   ├── models/               # Data models
│   │   │   ├── mod.rs
...
│   │   │   ├── dynamodb.rs         # DynamoDB interactions
│   │   │   ├── external.rs         # External service calls
│   │   │   └── mock_db.rs          # Mock database for testing
...
## Class Diagram
![CleanShot 2024-11-04 at 03 09 01](https://github.com/user-attachments/assets/f193d8f2-881d-4aba-a169-7b769be54339)


> [!NOTE]
> All sections below this NOTE are auto-generated by AWS SAM CLI
